...
if [ -z "$SOLANA_DOWNLOAD_ROOT" ]; then
    SOLANA_DOWNLOAD_ROOT="https://github.com/allnodes/solana-paladin/releases/download"
fi
GH_LATEST_RELEASE="https://api.github.com/repos/allnodes/solana-paladin/releases/latest"
