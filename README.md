<p align="center">
    <br /><br />
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="allnodes/images/paladin-dark-mode.png">
      <img alt="Paladin Allnodes Edition" src="allnodes/images/paladin-light-mode.png" style="width: 16em">
    </picture>
</p>


# Paladin's fork of the Solana validator with modifications from Allnodes

## Modifications made by Allnodes

This repository features the following enhancements to the Paladin codebase:
...
```bash
$ git clone --recursive https://github.com/allnodes/solana-paladin --branch <version>
$ cd solana-paladin
```
